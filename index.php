        ...
        <div class="sec1-content">
            <div class="banner">
                ...
                <div class="banner-info">
                    ...
                    <p class="banner-info-p">Dans plus de 12 destinations</p>
                    <div class="banner-info-button">
                        <button class="banner-info-button-reserve"  onclick="window.location='booking.php';">Je réserve</button>
                        ...
                        <select id="VilleArrivee" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <?php
                                if (isset($_GET['villeDepart'])) {
                                    ...
                                    $res2 = mysqli_query($cnt, "SELECT port.idVille, port.ville, port.photo FROM port,liaison WHERE liaison.idvilleArrivee=$villeDepart AND port.idVille=liaison.idvilleDepart;");
            ...
            <div class="sec2-list">
                <?php 
                    while ($tab = mysqli_fetch_row($res3)) {
                        ...
                        if($id != NULL){
                            echo("<div class=\"sec2-list-cadre\">
