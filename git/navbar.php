...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <ul> <!-- Menu redirection -->
            ...
            <li class="<?php echo addActiveClass('destinations.php', $currentPage);
                        addActiveClass('destinations-detail.php', $currentPage) ?>">
                <a href="destinations.php"><i class='bx bx-map-alt'></i>Nos destinations</a>
            </li>
            <li class="<?php echo addActiveClass('resa-login.php', $currentPage);
                        addActiveClass('resa-detail.php', $currentPage) ?>">
