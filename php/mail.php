<?php
    echo("<a href=\"\" onclick=\"confirmationMail('00000','marieteamap@gmail.com')\">Envoyer test</a>"); // Bouton de test

    // Fonction d'envoi de mail selon les variables de la réservation
    function confirmationMail($idResa,$mailDestinaire,$telDestinataire,$prenom,$nom,$dateD,$heureD,$dateA,$heureA,$villeD,$paysD,$villeA,$paysA,$photo){
        // Verification des mail destinataire
        ...
        $heureA = new DateTime($heureA);

        $sujet = '⛴️ Confirmation de réservation'; // Sujet du mail
                    ...
                    <tr>
                      ...
                      <table cellpadding=\"0\" cellspacing=\"0\" aligne-items=\"left\" class=\"es-left\" role=\"none\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left\">
                        <tr>
                          ...
                          <table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
                            <tr>
                              <td aligne-items=\"left\" background-color=\"#cbdaff\" style=\"padding:10px;Margin:0\"><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">$villeD, $paysD</p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">".$formatter->format($dateD)."</p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">".$heureD->format('G\hi')."</p></td>
                            </tr>
                          </table></td>
                      ...
                      <table cellspacing=\"0\" aligne-items=\"right\" cellpadding=\"0\" class=\"es-right\" role=\"none\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right\">
                        <tr>
                          ...
                          <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
                            <tr>
                              <td aligne-items=\"left\" background-color=\"#cbdaff\" style=\"padding:10px;Margin:0\"><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">$villeA, $paysA</p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">".$formatter->format($dateA)."</p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">".$heureA->format('G\hi')."</p></td>
                            </tr>
                          </table></td>
                        </tr>
                      ...
                      <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"none\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
                        <tr>
                          ...
                          <table width=\"100%\" role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
                            <tr>
                              <td aligne-items=\"left\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">Bonjour $prenom,<br> Votre réservation $villeD vers $villeA à bien été pris en compte.</p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">Veillez conserver votre référence de réservation.</p></td>
                            </tr>
                            <tr>
                              <td aligne-items=\"center\" height=\"40\" style=\"padding:0;Margin:0;font-size:0\"></td>
                            </tr>
                            <tr>
                              <td aligne-items=\"center\" style=\"padding:0;Margin:0;font-size:0\"><img src=\"$photo\" alt=\"\" width=\"560\" class=\"adapt-img\" style=\"display:block;font-size:14px;border:0;outline:none;text-decoration:none;border-radius:19px\"></td>
                            </tr>
                            <tr>
                      ...
                      <table cellpadding=\"0\" cellspacing=\"0\" aligne-items=\"left\" class=\"es-left\" role=\"none\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left\">
                        <tr>
                          ...
                          <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
                            ...
                            <tr>
                              <td aligne-items=\"left\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">Nom et prénom: <strong>$nom $prenom</strong></p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">Adresse mail: <strong> $mailDestinaire</strong></p><p style=\"Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px\">Tel: <strong> $telDestinataire</strong></p></td>
                            </tr>
                            <tr>
                              <td aligne-items=\"center\" height=\"40\" style=\"padding:0;Margin:0;font-size:0\"></td>
                            </tr>
        ...
        $destinataire = "$mailDestinaire"; // Mail de destinaire
        $header = "From:\"Marie Team\"<contact@juliengournay.fr>\n"; // Nom et adresse mail de l'expéditeur
        $header .="Reply-To:marieteamap@gmail.com\n"; // Mail de reponse
        $header .= "Content-Type: text/html; charset=\"iso-8859-1\"";
        if (mail($destinataire, $sujet, $message, $header)){ // Envoi du mail si toute les données sont présentes
