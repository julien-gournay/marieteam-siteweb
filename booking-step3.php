...
<body>
    ...
    <section id="sec-1">
        <form class="cadre" method="POST" action=""> <!-- Formulaire de l'etape 3 -->
                ...
                <div class="cadre-recap-ct">
                    ...
                    <div class="cadre-recap-ct-gp">
                        ...
                        <?php
                            ...
                            foreach ($_SESSION as $key => $value) {
                                $res_typeP = mysqli_query($cnt, "SELECT type.libelleType,type.idCategorie,tarif.tarif FROM tarif,type WHERE type.idType='$key' AND type.idType=tarif.idType AND type.idCategorie='A';"); // Requête : 
                                if ((mysqli_num_rows($res_typeP) > 0)&&($value > 0)) {
                                    while ($tab = mysqli_fetch_row($res_typeP)) {
                                        ...
                                        $prixTotalP = $prixTotalP + $prixTypeP;
                            ...
                            if (mysqli_num_rows($res_typeP) > 0) {
                                echo("    
                                <div class=\"cadre-recap-ct-gp-txt\">
                    ...
                    <div class="cadre-recap-ct-gp">
                        ...
                        <?php
                            ...
                            //$TypeV = 0;
                            foreach ($_SESSION as $key => $value) {
                                $res_typeV = mysqli_query($cnt, "SELECT type.libelleType,type.idCategorie,tarif.tarif FROM tarif,type WHERE type.idType='$key' AND type.idType=tarif.idType AND type.idCategorie!='A';"); // Requête : 
                                if ((mysqli_num_rows($res_typeV) > 0)&&($value > 0)) {
                                    while ($tab = mysqli_fetch_row($res_typeV)) {
                                        ...
                                        $prixTotalV = $prixTotalV + $prixTypeV;
                            ...
                            if (mysqli_num_rows($res_typeV) > 0) {
                                echo("    
                                <div class=\"cadre-recap-ct-gp-txt\">
                    ...
                    <div class="cadre-recap-ct-bt">
                        <button class="cadre-recap-ct-bt-ann"><a href="booking-step2.php">Précedement</a></button> <!-- Bouton retour etape -->
